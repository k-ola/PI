...
class LongMapActivity : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnPolylineClickListener, GoogleMap.OnCircleClickListener {
    ...
    override fun onMapReady(map: GoogleMap) {
        ...
        map.addMarker(
            MarkerOptions()
                .position(wiadukt)
                .title("Wiadukt kolejki wąskotorowej")
                .icon(BitmapDescriptorFactory.fromResource(com.example.wbunkry.R.drawable.vsrec_green)
                ))
        ...
        map.addMarker(
            MarkerOptions()
                .position(grecka1)
                .title("Stanowisko 1")
                .snippet("Działobitnia dla armat 105 mm baterii greckiej")
                .icon(BitmapDescriptorFactory.fromResource(com.example.wbunkry.R.drawable.vsdot_yellow)
                ))
        ...
        map.addMarker(
            MarkerOptions()
                .position(bas3b1)
                .title("1101")
                .snippet("Stanowisko ogniowe dla dział 152.4 mm 3. BAS z 1956 roku")
                .icon(BitmapDescriptorFactory.fromResource(com.example.wbunkry.R.drawable.vsdot_red)
                ))
        ...
        map.addMarker(
            MarkerOptions()
                .position(bas3d)
                .title("1106")
                .snippet("Punkt kierowania ogniem z artyleryjską stacją radiolokacyjną 3. BAS zbudowany" +
                        "w 1956 roku")
                .icon(BitmapDescriptorFactory.fromResource(com.example.wbunkry.R.drawable.vsdot_full_red)
                ))
        ...
        map.addMarker(
            MarkerOptions()
                .position(bas3e)
                .title("1109")
                .snippet("Elektrownia z hydrofornią 3. BAS z 1958 roku")
                .icon(BitmapDescriptorFactory.fromResource(com.example.wbunkry.R.drawable.vsdot_full_red)
                ))
        ...
        map.addMarker(
            MarkerOptions()
                .position(bas3f)
                .title("1111")
                .snippet("Schron załogi dla 3. BAS z 1956 roku")
                .icon(BitmapDescriptorFactory.fromResource(com.example.wbunkry.R.drawable.vsdot_full_red)
                ))
        ...
        map.addMarker(
            MarkerOptions()
                .position(bas3h1)
                .title("1117")
                .snippet("Schron-garaż dla reflektorów do strzelań nocnych 3. BAS z 1957 roku")
                .icon(BitmapDescriptorFactory.fromResource(com.example.wbunkry.R.drawable.vsdot_full_red)
                ))
        ...
        map.addMarker(
            MarkerOptions()
                .position(bas3i)
                .title("1121")
                .snippet("Schron obserwacyjny dowódcy plutonu ogniowego 3. Baterii Artylerii Stałej")
                .icon(BitmapDescriptorFactory.fromResource(com.example.wbunkry.R.drawable.vsdot_full_red)
                ))
        ...
        map.addMarker(
            MarkerOptions()
                .position(bat34b)
                .title("34/2")
                .snippet("Fundament podwójnej armaty 120 mm 34. Baterii")
                .icon(BitmapDescriptorFactory.fromResource(com.example.wbunkry.R.drawable.vsdot_yellow)
                ))
        ...
        map.addMarker(
            MarkerOptions()
                .position(zbPP)
                .title("Zbiorniki paliw płynnych")
                .icon(BitmapDescriptorFactory.fromResource(com.example.wbunkry.R.drawable.vssquare_yellow)
                ))
        ...
        map.addMarker(
            MarkerOptions()
                .position(bplotbor2)
                .title("Wieża artylerii osłonowej")
                .icon(BitmapDescriptorFactory.fromResource(com.example.wbunkry.R.drawable.vsdot_blue)
                ))
        ...
        map.addMarker(
            MarkerOptions()
                .position(bas3l1)
                .title("Schron załogi")
                .snippet("Schron załogi lewego punktu obserwacji dwubocznej 3. BAS")
                .icon(BitmapDescriptorFactory.fromResource(com.example.wbunkry.R.drawable.vsdot_full_red)
                ))
        ...
        map.addMarker(
            MarkerOptions()
                .position(bplot22c)
                .title("Fundament wieży dowodzenia")
                .icon(BitmapDescriptorFactory.fromResource(com.example.wbunkry.R.drawable.vssquare_yellow)
                ))
        ...
        map.addMarker(
            MarkerOptions()
                .position(nukSchr)
                .title("Nieukończony schron przeciwlotniczy typu T-750")
        ...
        map.addMarker(
            MarkerOptions()
                .position(pwJast1)
                .title("Podstawa wieży dla działek")
                .icon(BitmapDescriptorFactory.fromResource(com.example.wbunkry.R.drawable.vssquare_blue)
                ))
