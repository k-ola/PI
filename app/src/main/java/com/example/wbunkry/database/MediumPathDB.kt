...
object MediumPathDB {
    ...
    val poiListMedium: ArrayList<MediumPois> = arrayListOf<MediumPois>(
        ...
        MediumPois("PKT_OBS.jpg","Punkt obserwacyjny","54.61476338675549","18.82229929820359","Punkt obserwacyjny MW czynny od 1920 roku został w 1928 zmodernizowany przez dobudowanie wieży drew¬nianej i wartowni. Rozbudowany przez Niemców po zajęciu Półwyspu. W pobliżu na wysokiej (15 m n. p. m.) wydmie nazywanej Bocianie Gniazdo lub potocznie „bocianica” przed wojną funkcjonował punkt widokowy stanowiący atrakcję dla letników. Wieża konstrukcji drewnianej stała jeszcze w latach 50-tych XX w. Obecnie zachowały się jedynie betonowe fundamenty składające się z 9 kwadratowych bloków. Po wojnie w bezpośrednim sąsiedztwie wieży zbudowano fragment Batalionowego Rejonu Umocnionego.",
