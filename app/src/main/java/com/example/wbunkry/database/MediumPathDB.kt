...
class MediumPathDB {
    ...
    val poiListMedium: ArrayList<LongPois> = arrayListOf<LongPois>(
        ...
        LongPois("tlo.jpg","115. Bateria Przeciwlotnicza Marynarki Wojennej","54.637436303677376","18.80463915587521","Zbudowana w 1974 r. W skład baterii wchodziło 6 stanowisk ogniowych z batonowych elementów prefabrykowanych dla armat plot. wz. 1939 kal. 37 mm rozmieszczonych na okręgu, w rejonie ronda wykorzystywanego wcześniej przez prawy reflektor 3. BAS. Baterię rozformowano na początku 1990 r. W 2011 roku obiekty baterii rozebrano.",
            MarkerOptions().title("115. Bateria Przeciwlotnicza Marynarki Wojennej").position(
                LatLng(54.637436303677376,18.80463915587521)
            )),
        LongPois("tlo.jpg","3. Bateria Artylerii Stałej","54.63762744956966","18.80074626952667","Największa powojenna polska bateria nadbrzeżna, uzbro¬jona w cztery działa radzieckie typu MU-2 kal. 152 mm. Budowę prowadzono w latach 1955-1958, kiedy to powstały cztery stanowiska ogniowe ze schronami załogi, schron centrali artyleryjskiej oraz główny i zapasowy punkt kierowania ogniem oraz szereg obiektów pomocni¬czych: schrony reflektorów, magazyn amunicyjny, elektrownię i schron załogi. Na skrzydłach baterii posta¬wiono punkty obserwacji dwubocznej w rejonie Juraty i Góry Szwedów. Baterię rozformowano w 1977 r., a jedyne ocalałe działo kal. 152 mm można oglądać w Muzeum Wojska Polskiego w Warszawie. W 2011 roku część obiek¬tów baterii rozebrano, a pozostałe zostały zasypane i są obecnie niedostępne. Wartymi zobaczenia są dwie zacho¬wane pancerne kopuły dla dalmierzy.",
            MarkerOptions().title("3. Bateria Artylerii Stałej").position(
                LatLng(54.63762744956966,18.80074626952667)
            )),
        LongPois("tlo.jpg","Bateria Artylerii nr 34","54.647141741459286","18.788801814824204","Zbudowana już w czasie kampanii wrześniowej w sposób improwizowany. Jej uzbrojenie stanowiły dwa działa kal. 120 mm firmy Bofors (jedno pojedyncze, a drugie podwójne), zdjęte z zatopionego 3 września w porcie helskim, stawiacza min ORP „Gryf\". Gotowość bojową osiągnęła tuż przed kapitulacją Helu i nie zdążyła wziąć udziału w walkach. Oddano jedynie kilka strzałów technicznych. Do naszych czasów zachowały się obie betonowe podstawy z pierścieniami służącymi do mocowania armat odkryte w 2006 roku przez miłośników fortyfikacji.",
            MarkerOptions().title("Bateria Artylerii nr 34").position(
                LatLng(54.647141741459286,18.788801814824204)
            )),
        LongPois("tlo.jpg","Posterunek Plutonu Rozpoznania Radioelektronicznego","54.647414884409706","18.786130334786442","Posterunek plutonu 14 Batalionu Rozpoznania Radioelek¬tronicznego zlikwidowany w latach 90. Na szczycie wydmy znajduje się wybetonowane stanowisko, na którym stały pojazdy i przyczepy z wyposażeniem. Poniżej ustawiono niewielka wiatę. W 2011 roku pozostałości posterunku rozebrano.",
            MarkerOptions().title("Posterunek Plutonu Rozpoznania Radioelektronicznego").position(
                LatLng(54.647414884409706,118.786130334786442)
            )),
        LongPois("tlo.jpg","Bateria Artylerii nr 32 \"Grecka\"","54.64046892950777","18.801123008136145","Oddana do użytku w 1932 r., uzbrojona była w dwie polowe armaty kal. 105 mm firmy Schneider, które zaadoptowano na potrzeby baterii nadbrzeżnej poprzez ustawienie na betonowych działobitniach. W pobliżu stanowisk ogniowych wybudowano dwa schrony dla załogi. W czasie kampanii wrześniowej armaty przetransportowano w okolice Juraty w celu wsparcia obrońców od strony nasady półwyspu. Wraz z baterią „duńską\\\" były pierwszy¬mi stałymi elementami obrony wybrzeża na Półwyspie Helskim. Podczas okupacji Kriegsmarine zaadaptowała działobitnie i schrony na potrzeby własnej baterii nadbrzeżnej. Obiekty baterii znajdują się przy utwardzonej drodze w rejonie Hel Bór.\",\n",
            MarkerOptions().title("Bateria Artylerii nr 32 \"Grecka\"").position(
                LatLng(54.64046892950777,18.801123008136145)
            )),


        LongPois("tlo.jpg","Magazyn torped","54.595660407136165","18.808104214431733","Wybudowane w 1936 r. w formie czterech żelbetowych schronów częściowo zagłębionych w ziemi, przez które poprowadzono tory kolejki wąskotorowej. Obiekt niedo¬stępny, nadal użytkowany przez wojsko.",
            MarkerOptions().title("Magazyn torped").position(
                LatLng(54.595660407136165,18.808104214431733)
            )),


        LongPois("tlo.jpg","Magazyny min morskich","54.6453432489814","18.779727859570915","Budowę rozpoczęto w 1933 r. Wybudowano trzy hale magazynowe, częściowo zagłębione w ziemi oraz budynek trotylarni. Przez każdą z hal poprowadzono tor kolejki wąskotorowej, za pomocą której transportowano miny do nabrzeży portowych. Obiekt niedostępny, nadal użytkowany przez wojsko.",
            MarkerOptions().title("Magazyny min morskich").position(
                LatLng(54.6453432489814,18.779727859570915)
            )),
        LongPois("tlo.jpg","Zbiorniki paliw płynnych","54.65192281320633","18.780253428637103","Dwa zbiorniki o pojemności po 1000 ton dla paliwa ciężkiego stosowanego w okrętach nawodnych. W latach 1934-35 zdołano wybudować tylko same zbiorniki i ruro¬ciąg do portu. Przed wojną zabrakło czasu na wykonanie stacji pomp oraz innych instalacji. Podczas okupacji obiekt został zmodernizowany i wykorzystywany na potrzeby Kriegsmarine. Po wojnie ponownie rozbudowany. Obiekty są niedostępne, nadal użytkowane przez wojsko.",
            MarkerOptions().title("Zbiorniki paliw płynnych").position(
                LatLng(54.65192281320633,18.780253428637103)
            )),
        LongPois("tlo.jpg","Bateria Przeciwlotnicza \"Hel-Bór\"","54.65517692196562","18.77472981722428","Niemiecka tzw. zaporowa bateria przeciwlotnicza (Sperr- batterie) zbudowana ok. 1940 r. Uzbrojona w cztery działa S.K. C/32 kalibru 105 mm ustawione na betonowych fundamentach. Zadaniem baterii była ochrona podejść do Zatoki Gdańskiej, a rozmieszczenie stanowisk ogniowych umożliwiało zarówno walkę z samolotami jak i mniejszymi okrętami przeciwnika. W pobliżu wzniesiono dwukondy¬gnacyjny schron kierowania ogniem wyposażony w dalmierz zamontowany na stropie pod pancerną kopułą (obecnie zdemontowany). Za schronem na wydmie zacho¬wał się fundament po wieży konstrukcji drewnianej, na której zamontowane było działko szybkostrzelne kalibru 20 mm, służące bezpośredniej obronie baterii. W 1943 r. obiekt obsadziła jedna z baterii 818. morskiego oddziału artylerii plot (Marinę Flak Abteilung 818) przeniesionego na Półwysep z Lorient we Francji.",
            MarkerOptions().title("Bateria Przeciwlotnicza \"Hel-Bór\"").position(
                LatLng(54.595660407136165,18.77472981722428)
            )),
        LongPois("tlo.jpg","23. Bateria Przeciwlotnicza","54.655306418529776","18.76936579830346","Wraz z bliźniaczymi bateriami 21 i 22 wchodziła w skład 2 Morskiego Dywizjonu Artylerii Przeciwlotniczej. Uzbro¬jona była w dwie armaty kalibru 75 mm firmy Schneider, ustawione na stropach schronów amunicyjnych zbudowa¬nych w latach 1933-35. U podnóża wydmy, na której stały armaty znajdował się obecnie zniszczony i zasypany schron amunicyjny. Podstawowym zadaniem baterii w trakcie kampanii wrześniowej była obrona przeciwlotni¬cza rejonu Hel-Bór, w tym znajdujących się niedaleko podziemnych zbiorników paliwa oraz ewentualna obrona przeciwdesantowa. Podczas okupacji Kriegsmarine zaadaptowała schrony na potrzeby własnej baterii przeciwlotni¬czej. Bateria znajduje się w pasie wydm w rejonie Hel-Bór, tuż przy torach kolejowych.",
            MarkerOptions().title("23. Bateria Przeciwlotnicza").position(
                LatLng(54.655306418529776,18.76936579830346)
            )),


        LongPois("tlo.jpg","64. Dywizjon Rakietowy WLOP","54.595660407136165","18.808104214431733","Formowanie jednostki rozpoczęto w 1973 r. Dywizjon uzbrojono w 4 kierowane rakiety przeciwlotnicze systemu S-125M „Newa” (mogące także razić cele nawodne), których wyrzutnie rozmieszczono wachlarzem skierowa¬nym na morze. Pomiędzy wyrzutniami znajduje się obsypany ziemią schron mieszczący stanowisko dowodzenia, garaże na pojazdy z wyposażeniem, gazoszczelny schron przeciwlotniczy oraz pomieszczenia socjalno-byto¬we obsługi. Na stropie schronu umieszczono stanowisko radaru naprowadzania rakiet. Na terenie dywizjonu powstało ponadto szereg innych obiektów jak schron magazyn rakiet, betonowe boksy-garaże każdy dla dwóch samochodów transportowo załadowczych z zapasowymi rakietami, szereg małych schronów przeciwlotniczych itd. Dywizjon, który wchodził w skład 4 Brygady Rakietowej OP, rozformowano we wrześniu 1993 r. W 2011 roku obiekty dywizjonu całkowicie rozebrano.",
            MarkerOptions().title("64. Dywizjon Rakietowy WLOP").position(
                LatLng(54.595660407136165,18.808104214431733)
            )),


        LongPois("tlo.jpg","Lewy Punkt Obserwacji Dwubocznej 3. Baterii Artylerii Stałej","54.679459246384276","18.734926183440574","Stanowisko, zbudowane około 1957 r., służyło do obserwa¬cji i awaryjnego kierowania ogniem 3. BAS. Obok ażuro¬wej, żelbetowej wieży obserwacyjnej zbudowano także schron dla załogi stanowiska. Podobny obiekt, jednak bez schronu załogi, zbudowano w rejonie Góry Szwedów.",
            MarkerOptions().title("Lewy Punkt Obserwacji Dwubocznej 3. Baterii Artylerii Stałej").position(
                LatLng(54.679459246384276,18.734926183440574)
            )),
        LongPois("tlo.jpg","Magazyny amunicji","54.63885659627331","18.775781511872815","Wybudowane w 1937 r. w formie obsypanych ziemią hal o długości 30 m każda (łącznie 11 obiektów), przez środek których prowadził tor kolejki wąskotorowej. W magazy¬nach przechowywano amunicję artyleryjską dla okrętów. W trakcie kampanii wrześniowej w jednym ze schronów mieściło się dowództwo Rejonu Umocnionego „Hel”. Obiekt niedostępny, nadal użytkowany przez wojsko",
            MarkerOptions().title("Magazyny amunicji").position(
                LatLng(54.63885659627331,18.775781511872815)
            )),
        LongPois("tlo.jpg","22. Bateria Przeciwlotnicza","54.629947055292554","18.777229237985956","Tzw. „bateria portowa\". Wraz z bliźniaczymi bateriami 21 i 23 wchodziła w skład 2 Morskiego Dywizjonu Artyle¬rii Przeciwlotniczej. Uzbrojona była w dwie armaty kalibru 75 mm firmy Schneider ustawione na stropach schronów amunicyjnych zbudowanych w łatach 1933-35. Ok. 150 m na północ od stanowisk baterii stała wybudowa¬na w 1936 r. wieża obserwacyjna dowódcy 2. MDAPlot. (tzw. „wieża Wojcieszka\", swoją potoczną nazwę wzięła od nazwiska dowódcy dywizjonu, kpt. mar. Mariana Wojcieszka), po której zachowały się betonowe funda¬menty. Podstawowym zadaniem baterii w trakcie kampa¬nii wrześniowej była obrona przeciwlotnicza portu wojen¬nego oraz ewentualna obrona przeciwdesantowa. Podczas okupacji Kriegsmarine zaadaptowała schrony na potrzeby własnej baterii przeciwlotniczej. Obecnie bateria znajdu¬je się na wysokiej wydmie w północno-zachodniej części Ośrodka Wypoczynkowego „Kormoran”.",
            MarkerOptions().title("22. Bateria Przeciwlotnicza").position(
                LatLng(54.629947055292554,18.777229237985956)
            )),
        LongPois("tlo.jpg","Nieukończony schron przeciwlotniczy","54.61613998868892","18.785217517787196","Budowany dla załóg doświadczalnej jednostki okrętów podwodnych schron typu T 750. Z trzech kondygnacji wybudowano tylko jedną. Posiadał ściany grubości 2,5 m. Obiekt na terenie wojskowym.",
            MarkerOptions().title("Nieukończony schron przeciwlotniczy").position(
                LatLng(54.61613998868892,18.785217517787196)
            )),
        LongPois("tlo.jpg","Ośrodek oporu \"Jastarnia\"","54.71646579114099","18.634613571143376","Wybudowany tuż przed wybuchem II wojny światowej, składał się z wysuniętej pozycji polowej, pozycji głównej oraz pozycji tyłowej. Do wybuchu wojny wykonano 4 ciężkie schrony pozycji głównej (o nazwach własnych „Sęp”, „Sokół”, „Sabała”, „Saratoga”), jeden schron lekki pozycji tyłowej oraz fundamenty pod planowane trzy pozostałe. Dwa z ciężkich schronów („Sabała” i „Sęp”) miały zostać wyposażone w pancerne kopuły z armatami przeciwpancernymi kalibru 37 mm, jednak do wybuchu wojny nie dostarczono ich na Półwysep. Obecnie wszystkie schrony zostały odrestaurowane, a w okresie wiosenno-letnim dwa z nich udostępniane są do zwiedzania. Zwiedzanie ułatwia ścieżka dydaktyczna prowadząca wśród umocnień i odtworzonych przeszkód.",
            MarkerOptions().title("Ośrodek oporu \"Jastarnia\"").position(
                LatLng(54.71646579114099,18.634613571143376)
            )),
        LongPois("tlo.jpg","Bateria Przeciwlotnicza \"Jastarnia\"","54.694025297574804","18.694279711700137","Niemiecka tzw. zaporowa bateria przeciwlotnicza (Sperrbatterie) zbudowana ok. 1940 r. Uzbrojona w cztery działa kal. 105 mm ustawione na betonowych fundamentach. Zadaniem baterii była ochrona podejść do Zatoki Gdańskiej, a rozmieszczenie stanowisk ogniowych umożliwiało zarówno walkę z samolotami jak i mniejszymi okrętami przeciwnika. Za torami na wysokiej wydmie zbudowano dwukondygna¬cyjny schron kierowania ogniem wyposażony w dalmierz zamontowany pod pancerną kopułą. Na skrzydłach baterii zachowały się fundamenty po dwóch wieżach, na których zamontowane były działka szybkostrzelne kalibru 70 mm służące bezpośredniej obronie baterii oraz stanowisko małego radaru.",
            MarkerOptions().title("Bateria Przeciwlotnicza \"Jastarnia\"").position(
                LatLng(54.694025297574804,18.694279711700137)
            )),
        LongPois("tlo.jpg","Wraki okrętów","54.613967713736166","18.7785620433556","Wraki powojennych niszczycieli ORP Wicher II oraz ORP Grom II zatopiony ok. 1977 r. w pobliżu portu wojennego jako elementy falochronu.",
            MarkerOptions().title("Wraki okrętów").position(
                LatLng(54.613967713736166,18.7785620433556)
            )),
