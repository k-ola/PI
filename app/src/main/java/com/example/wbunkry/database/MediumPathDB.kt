...
object MediumPathDB {
    ...
    val poiListMedium: ArrayList<MediumPois> = arrayListOf<MediumPois>(
        ...
        MediumPois("ELEKTROWNIARUH.jpg","Elektrownia Rejonu Umocnionego Hel","54.62688381558725","18.789661755818205","Budowę rozpoczęto w 1935 r., a oddano do użytku wiosną 1939 r. Miała zapewnić dostawę elektryczności dla potrzeb wojska jak i dla odbiorców cywilnych. Prąd wytwarzany był przy pomocy dwóch agregatów o mocy 400 KM oraz jednego o mocy 100 KM. Elektrownia zaopatrywała w energię również pobliską Jastarnię. Obiekt niedostępny do zwiedzania - użytkowany przez wojsko.",
            MarkerOptions().title("").position(
                LatLng(54.62688381558725,18.789661755818205)
            )),
        MediumPois("PKT_OBS.jpg","Punkt obserwacyjny","54.61476338675549","18.82229929820359","Punkt obserwacyjny MW czynny od 1920 r. został w 1928 r. zmodernizowany poprzez dobudowanie drewnianej wieży i wartowni. Rozbudowany przez Niemców po zajęciu Półwyspu. W pobliżu na wysokiej (15 m n.p.m.) wydmie nazywanej Bocianie Gniazdo lub potocznie „bocianica” przed wojną funkcjonował punkt widokowy stanowiący atrakcję dla letników. Wieża konstrukcji drewnianej stała jeszcze w latach 50-tych XX w. Obecnie zachowały się jedynie betonowe fundamenty składające się z 9 kwadratowych bloków. Po wojnie w bezpośrednim sąsiedztwie wieży zbudowano fragment Batalionowego Rejonu Umocnionego.",
            MarkerOptions().title("Punkt obserwacyjny").position(
                LatLng(54.61476338675549,18.82229929820359)
            )),
        MediumPois("BATD_SKA.jpg","Bateria Artylerii nr 33 \"Duńska\"","54.617684076054765","18.82369119820373","Oddana do użytku w 1932 r. Uzbrojona była w dwie armaty kal. 105 mm firmy Schneider, które zaadaptowano na potrzeby baterii nadbrzeżnej poprzez ustawienie na betonowych działobitniach. W pobliżu stanowisk ogniowych wybudowano dwa schrony dla załogi. W trakcie kampanii wrześniowej prowadziła ostrzał lekkich sił nawodnych Kriegsmarine. Wraz z baterią „grecką” były pierwszymi stałymi elementami obrony wybrzeża na Półwyspie Helskim. Podczas okupacji Kriegsmarine zaadaptowała działobitnie i schrony na potrzeby własnej baterii nadbrzeżnej. Obiekty baterii zostały odnowione przez Muzeum Obrony Wybrzeża w 2011 roku.",
